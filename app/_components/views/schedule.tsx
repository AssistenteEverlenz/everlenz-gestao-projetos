...
type Props = { project: Project; tasks: Task[]; entries: JournalEntry[]; members: Member[]; navigate: (view: ViewId) => void; metrics: { overall: number; active: number }; addTask: (task: Task) => void; editTask: (task: Task) => Promise<void>; editEntry: (entry: JournalEntry) => Promise<void>; updateTaskProgress: (id: string, progress: number) => void; setToast: (value: string) => void };
...
export function Schedule({ project, tasks, entries, members, metrics, addTask, editTask, editEntry, updateTaskProgress, setToast }: Props) {
